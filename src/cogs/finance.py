...
=======
        await self.bot.change_presence(activity=discord.Game(f"Bitcoin: {btc_price}"), status=discord.Status.online)
>>>>>>> Notify failure in tests
...
=======
        await self.bot.change_presence(activity=discord.Game(f"Ethereum: {ether_price}"), status=discord.Status.online)
>>>>>>> Notify failure in tests
        await asyncio.sleep(10)
...
=======
        await self.bot.change_presence(activity=discord.Game(f"Litecoin: {ltc_price}"), status=discord.Status.online)
>>>>>>> Notify failure in tests
        await asyncio.sleep(10)
    ...
    async def btc(self, ctx):
        btc = bitcoin()
        emb = discord.Embed(
            title="Bitcoin", color=discord.Color.gold()
        )
        emb.add_field(
            name="USD",
            value=f"{btc[0]}$",
        ...
        emb.set_thumbnail(url="https://usethebitcoin.com/wp-content/uploads/2018/08/bitcoin-pic-main-500x500.png")
