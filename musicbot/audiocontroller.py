...
class AudioController(object):
    ...
    def __init__(self, stonks, guild):
        self.stonks = stonks
    ...
    def next_song(self, error):
        ...
        self.stonks.loop.create_task(coro)
    ...
    async def play_song(self, song):
        ...
        for song in list(self.playlist.playque)[:10]:
        ...
        if playlist_type == linkutils.Playlist_Types.BandCamp_Playlist:
            ...
            with youtube_dl.YoutubeDL(options) as ydl:
                ...
                for entry in r['entries']:
                    ...
                    self.playlist.add(song)
            for song in list(self.playlist.playque)[:15]:
                asyncio.ensure_future(self.preload(song))
